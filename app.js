...
L.tileLayer('https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}{r}.png', {
  attribution: '&copy; OpenStreetMap contributors &copy; CARTO | data: MESR open data (Licence Ouverte), same source as etudiant.gouv.fr map',
}).addTo(map);
...
function tick() {
  ...
  for (const it of items) {
    ...
    it.marker.bindPopup(popupHtml(it.places, statuses), { autoPan: true, maxWidth: 360, maxHeight: 430 });
